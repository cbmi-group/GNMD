...
## Framework of our denoising method  
...
### 1. P2P-NM train/test
   ...
   Model weights will be saved at *P2P-NM/checkpoints/trained_on_1080* 
   ...
   - The test results will be saved at *P2P-NM/results/trained_on_1080/edge_random_masks_latest*
 ...
 ### 3. P2P-DN train/test
   ...
   Weights will be saved at *P2P-DN/checkpoints/trained_on_1080*  
   ...
   - Results will be saved at *P2P-DN/results/trained_on_1080/*
 ## Contributing
